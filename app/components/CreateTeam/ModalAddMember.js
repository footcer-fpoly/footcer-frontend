...
const ModalAddMember = ({ visible, dismiss, member }) => {
    ...
    function haveUser() {
        return (
            <View style={styles.warpper}>
                ...
                <Text style={{ fontWeight: 'bold', fontSize: 18 }}>{user.displayName}</Text>
                <TouchableOpacity
                    style={styles.btn}
    ...
    function noneUser() {
        return (
            <View style={styles.warpper}>
                <View style={{ borderColor: '#27ae60', width: 90, height: 90, borderRadius: 45, borderWidth: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <SimpleLineIcons
                        name="screen-smartphone"
                        color={'#27ae60'}
                        size={50}
                ...
                <Text style={[styles.subText, { maxWidth: 280 }]}>Số điện thoại <Text style={{ fontWeight: 'bold' }}>09036363</Text> chưa có tài khoản trên Footcer</Text>
                <TouchableOpacity
                    style={styles.btn}
                // onPress={() => searchPhone(txtInput, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOiI3NzVkN2FhNS1lNjg4LTExZWEtYjRmYi0wMjQyYWMxMjAwMDIiLCJSb2xlIjowLCJleHAiOjE2MTEyODkxMzF9.Z0fQGLafgBHASwM8j5WLOg9wtxJx5pZkaSEvurkjS6U')}
                >
