...
export const SIGN_UP_FB_GG_SCREEN = 'register_fb_gg_screen';
...
export const UPDATE_PASS_SCREEN = 'update_pass_screen';
...
//STADIUM
export const STADIUM_DETAIL_SCREEN = 'stadium_detail_screen';
export const REVIEW_STADIUM_SCREEN = 'review_stadium_screen';
export const STADIUM_COLLAGE_DETAIL_SCREEN = 'stadium_collage_detail_screen';
